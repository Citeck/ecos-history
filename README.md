...
Welcome to the Citeck `ecos-history` repository! This repository contains the history tracking and auditing functionality for the Citeck platform. Citeck is a powerful and comprehensive enterprise content and operations system designed to streamline and automate business processes within organizations.
